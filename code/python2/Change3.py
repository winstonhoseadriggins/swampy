...
class Slider:
    ...
    def likelihood(self, f=None):
        ...
        # The following lines were intended to reduce leakage
        # (when f!=None), but I dunno...
...
def generate_data(sigma=1, n=100):
    ...
    t += [normalvariate(0.7,sigma) for i in xrange(n)]
    #t += [normalvariate(0,sigma) for i in xrange(n)]
    #t += [normalvariate(0,sigma) for i in xrange(n)]
    return t
